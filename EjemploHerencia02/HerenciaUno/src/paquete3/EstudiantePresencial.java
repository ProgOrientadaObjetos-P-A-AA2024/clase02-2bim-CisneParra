...
public class EstudiantePresencial extends Estudiante {
    ...
    public String toString() {
        ...
        return cadena;
        // Para poder imprimir el metodo toString de la super clase lo llamamos a
        // super punto to string
    }
     */
    @Override
    public String toString() {
        String cadena = String.format("Apellido: %s\n"
                + "Identificacion: %s\n"
                + "Valor matricula: %.2f\n",
                apellidosEstudiante, identificacionEstudiante, matriculaPresencial);
        return cadena;
    }
}
